...
static const char *utermtmuxcmd[]  = { "uxterm", "-bg", "black", "-fg", "#009999", "-cr", "#999900", "-si", "-vb", "+sb", "-fullscreen", "-sl", "0", "-tn", "xterm", "-C", "-fn", "-misc-fixed-medium-r-normal-*-14-130-75-75-c-70-iso10646-1", "-e", "exec tmux -2u -f ~/.tmux.conf.$HOST attach", NULL };
static const char *utermtmuxattachcmd[]  = { "uxterm", "-bg", "black", "-fg", "#009999", "-cr", "#999900", "-si", "-vb", "+sb", "-fullscreen", "-sl", "0", "-tn", "xterm", "-C", "-fn", "-misc-fixed-medium-r-normal-*-14-130-75-75-c-70-iso10646-1", "-e", "exec tmux -2u attach", NULL };
